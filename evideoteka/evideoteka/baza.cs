...
namespace evideoteka
{
    class baza
    {
        ...
        {
            string query = "SELECT * FROM korisnik WHERE status = 1";
        ...
        {
            string query = "SELECT idDistributer, naziv FROM distributer WHERE status = 1";
        ...
        {
            string query = "SELECT * FROM glumac WHERE status = 1";
        ...
        {
            string query = "SELECT * FROM adresa WHERE status = 1";
        ...
        {
            string query = "SELECT * FROM distributer WHERE status = 1";
            List<distributer> list = new List<distributer>();
            if (this.OpenConnection() == true)
            {
        ...
        {
            string query = "SELECT * FROM film WHERE status = 1";
            ...
            if (this.OpenConnection() == true)
            {
                ...
                while (dataReader.Read())
                {
                    ...
                    string pret3 = dataReader[8] + "";
                    distributer1.status = Int32.Parse(pret3); //jbg malo san sporiji
                    list.Add(distributer1);
        ...
        {
            string query = "SELECT * FROM nacionalnost WHERE status = 1";
        ...
        {
            string query = "SELECT * FROM redatelj WHERE status = 1";
        ...
        {
            string query = "SELECT * FROM zanr WHERE status = 1";
